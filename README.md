...
Java ApplicationTest Building <sup>1 вебинар, 1 неделя</sup>
-------------------------
...
Java ApplicationTest Development <sup>9</sup>
----------------------------
...
### ApplicationTest overview <sup>0.2</sup>
- [ ] ApplicationTest architecture
- DB
- backend
- API
- client
...
- [ ] ApplicationTest testing architecture
- [ ] Test scopes
